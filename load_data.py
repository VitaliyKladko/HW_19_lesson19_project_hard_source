...
def load_data(db):
    data = {
        ...
        "users": [
            {"email": "test@gmail.com", "password": "qwerty", "name": "test_name", "surname": "test_surname", "pk": 1},
            {"email": "vitaliykaldko@gmail.com", "password": "qwerty2", "name": "Vitaliy", "surname": "Kladko", "pk": 2}
        ],
    }
